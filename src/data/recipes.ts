...
const tier4Components: CraftingRecipe[] = [
  ...
  { id: 'thermal_regulator', name: 'Thermal Regulator Unit', category: 'component', requiredMachine: 'plasma_welder', ingredients: [{ itemId: 'thermal_plate', type: 'item', quantity: 2 }, { itemId: 'energy_channel', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Active heat management' },
  ...
  { id: 'flow_regulator', name: 'Flow Regulator', category: 'component', requiredMachine: 'plasma_welder', ingredients: [{ itemId: 'pressure_seal', type: 'item', quantity: 2 }, { itemId: 'precision_gear', type: 'item', quantity: 1 }, { itemId: 'cobalt', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Fluid flow controller' },
  { id: 'cooling_assembly', name: 'Cooling Assembly', category: 'component', requiredMachine: 'plasma_welder', ingredients: [{ itemId: 'thermal_regulator', type: 'item', quantity: 1 }, { itemId: 'flow_regulator', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Active cooling system' },
