...
export const FOUNDRY_TIERS: FoundryUpgrade[] = [
  ...
  { id: 'void_smelter_1', name: 'Void Electric Smelter I', tier: 17, cost: [
    ...
    { itemId: 'plutonium', type: 'ingot', quantity: 1 },
    { itemId: 'francium', type: 'ingot', quantity: 1 },
...
// Firearm internals and barrel assemblies — mid-game crafted parts
const ballisticComponents: CraftingRecipe[] = [
  { id: 'receiver_core', name: 'Receiver Core', category: 'component', requiredMachine: 'cnc_mill', ingredients: [{ itemId: 'structural_core', type: 'item', quantity: 1 }, { itemId: 'tungsten', type: 'ingot', quantity: 2 }, { itemId: 'fastener_set', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Precision-machined central receiver body' },
  { id: 'reinforced_barrel', name: 'Reinforced Barrel', category: 'component', requiredMachine: 'plasma_welder', ingredients: [{ itemId: 'titanium', type: 'ingot', quantity: 3 }, { itemId: 'metal_rod', type: 'item', quantity: 2 }], outputQuantity: 1, description: 'Heat-resistant rifled barrel' },
  { id: 'cryo_chamber_sleeve', name: 'Cryo-Chamber Sleeve', category: 'component', requiredMachine: 'cnc_mill', ingredients: [{ itemId: 'thermal_plate', type: 'item', quantity: 2 }, { itemId: 'cobalt', type: 'ingot', quantity: 2 }], outputQuantity: 1, description: 'Sub-zero containment sleeve' },
  { id: 'magnetic_rail_spine', name: 'Magnetic Rail Spine', category: 'component', requiredMachine: 'plasma_welder', ingredients: [{ itemId: 'magnetite', type: 'ingot', quantity: 3 }, { itemId: 'reinforced_shaft', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Magnetic accelerator rail core' },
  { id: 'pulse_chamber', name: 'Pulse Chamber', category: 'component', requiredMachine: 'cnc_mill', ingredients: [{ itemId: 'energy_conduit', type: 'item', quantity: 1 }, { itemId: 'pressure_core', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Resonant burst amplification chamber' },
  { id: 'gas_regulator_unit', name: 'Gas Regulator Unit', category: 'component', requiredMachine: 'cnc_mill', ingredients: [{ itemId: 'flow_regulator', type: 'item', quantity: 1 }, { itemId: 'pressure_seal', type: 'item', quantity: 2 }, { itemId: 'cobalt', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Propellant gas metering valve' },
  { id: 'smart_trigger_assembly', name: 'Smart Trigger Assembly', category: 'component', requiredMachine: 'cnc_mill', ingredients: [{ itemId: 'mechanical_joint', type: 'item', quantity: 1 }, { itemId: 'signal_conduit', type: 'item', quantity: 1 }, { itemId: 'gold', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Electronic sear and trigger mechanism' },
  { id: 'recoil_buffer_core', name: 'Recoil Buffer Core', category: 'component', requiredMachine: 'plasma_welder', ingredients: [{ itemId: 'high_tension_spring', type: 'item', quantity: 2 }, { itemId: 'dynamic_balancer', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Multi-stage recoil absorption unit' },
  { id: 'stabilization_rod', name: 'Stabilization Rod', category: 'component', requiredMachine: 'cnc_mill', ingredients: [{ itemId: 'precision_shaft', type: 'item', quantity: 1 }, { itemId: 'stabilizer_unit', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Barrel harmonics dampening rod' },
  { id: 'ventilation_shroud', name: 'Ventilation Shroud', category: 'component', requiredMachine: 'plasma_welder', ingredients: [{ itemId: 'thermal_regulator', type: 'item', quantity: 1 }, { itemId: 'structural_panel', type: 'item', quantity: 2 }], outputQuantity: 1, description: 'Perforated heat dissipation shroud' },
];

// ─── Energy Weapon Components (10) ───────────────────────────────────────────
const energyWeaponComponents: CraftingRecipe[] = [
  { id: 'veinite_core_cell', name: 'Veinite Core Cell', category: 'component', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'veinite', type: 'ingot', quantity: 2 }, { itemId: 'energy_channel_core', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Living-ore power cell node' },
  { id: 'plasma_induction_coil', name: 'Plasma Induction Coil', category: 'component', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'hyper_conductor', type: 'item', quantity: 1 }, { itemId: 'thorium', type: 'ingot', quantity: 1 }, { itemId: 'fine_wiring', type: 'item', quantity: 2 }], outputQuantity: 1, description: 'High-frequency plasma excitation coil' },
  { id: 'arc_capacitor', name: 'Arc Capacitor', category: 'electronic', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'capacitor', type: 'item', quantity: 4 }, { itemId: 'platinum', type: 'ingot', quantity: 1 }, { itemId: 'energy_compression', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Rapid-discharge high-voltage capacitor' },
  { id: 'flux_channeler', name: 'Flux Channeler', category: 'component', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'quantum_channel', type: 'item', quantity: 1 }, { itemId: 'iridium', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Directed magnetic flux conduit' },
  { id: 'energy_focusing_lens', name: 'Energy Focusing Lens', category: 'component', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'diamond', type: 'ingot', quantity: 1 }, { itemId: 'energy_transfer_core', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Crystalline beam-focusing element' },
  { id: 'quantum_disruptor_node', name: 'Quantum Disruptor Node', category: 'component', requiredMachine: 'advanced_fab', ingredients: [{ itemId: 'phase_alignment_core', type: 'item', quantity: 1 }, { itemId: 'californium', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Quantum-state interruption emitter' },
  { id: 'phase_modulator', name: 'Phase Modulator', category: 'component', requiredMachine: 'advanced_fab', ingredients: [{ itemId: 'phase_coupler', type: 'item', quantity: 1 }, { itemId: 'neptunium', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Wave-phase amplitude controller' },
  { id: 'ionization_grid', name: 'Ionization Grid', category: 'component', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'fine_wiring', type: 'item', quantity: 3 }, { itemId: 'platinum', type: 'ingot', quantity: 1 }, { itemId: 'signal_conduit', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Charged particle acceleration grid' },
  { id: 'singularity_seed', name: 'Singularity Seed', category: 'component', requiredMachine: 'advanced_fab', ingredients: [{ itemId: 'singularity', type: 'ingot', quantity: 1 }, { itemId: 'energy_singularity_housing', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Contained micro-collapse initiator' },
  { id: 'thermal_overdrive_unit', name: 'Thermal Overdrive Unit', category: 'component', requiredMachine: 'plasma_welder', ingredients: [{ itemId: 'cooling_assembly', type: 'item', quantity: 1 }, { itemId: 'energy_conduit', type: 'item', quantity: 2 }, { itemId: 'osmium', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Overclock heat-surge amplifier' },
];

// ─── Bio-Organic Parts (10) ──────────────────────────────────────────────────
const bioOrganicParts: CraftingRecipe[] = [
  { id: 'tendon_fiber_actuator', name: 'Tendon Fiber Actuator', category: 'component', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'veinite', type: 'ingot', quantity: 1 }, { itemId: 'cable_harness', type: 'item', quantity: 1 }, { itemId: 'spring_coil', type: 'item', quantity: 2 }], outputQuantity: 1, description: 'Biomechanical tension actuator' },
  { id: 'bone_lattice_frame', name: 'Bone-Lattice Frame', category: 'component', requiredMachine: 'plasma_welder', ingredients: [{ itemId: 'heavy_frame', type: 'item', quantity: 1 }, { itemId: 'veinite', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Ossified structural exoskeleton frame' },
  { id: 'neural_link_socket', name: 'Neural Link Socket', category: 'electronic', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'data_interface_base', type: 'item', quantity: 1 }, { itemId: 'veinite', type: 'ingot', quantity: 1 }, { itemId: 'gold', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Bio-neural interface port' },
  { id: 'living_grip_tissue', name: 'Living Grip Tissue', category: 'component', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'veinite', type: 'ingot', quantity: 2 }, { itemId: 'pressure_seal', type: 'item', quantity: 2 }], outputQuantity: 1, description: 'Reactive organic grip material' },
  { id: 'vein_pump_circulator', name: 'Vein Pump Circulator', category: 'component', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'flow_regulator', type: 'item', quantity: 1 }, { itemId: 'veinite', type: 'ingot', quantity: 1 }, { itemId: 'rotary_component', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Fluid circulation pump for bio-systems' },
  { id: 'parasite_host_chamber', name: 'Parasite Host Chamber', category: 'component', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'compact_housing', type: 'item', quantity: 1 }, { itemId: 'veinite', type: 'ingot', quantity: 2 }, { itemId: 'pressure_core', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Sealed chamber for symbiotic organism' },
  { id: 'bio_reactive_shell', name: 'Bio-Reactive Shell', category: 'component', requiredMachine: 'plasma_welder', ingredients: [{ itemId: 'veinite_core', type: 'item', quantity: 1 }, { itemId: 'reinforced_plate', type: 'item', quantity: 2 }], outputQuantity: 1, description: 'Self-healing organic armor shell' },
  { id: 'muscle_strand_bundles', name: 'Muscle Strand Bundles', category: 'component', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'veinite', type: 'ingot', quantity: 2 }, { itemId: 'cable_harness', type: 'item', quantity: 2 }], outputQuantity: 1, description: 'Synthetic muscle fiber cluster' },
  { id: 'synapse_relay_core', name: 'Synapse Relay Core', category: 'electronic', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'signal_conduit', type: 'item', quantity: 1 }, { itemId: 'veinite', type: 'ingot', quantity: 1 }, { itemId: 'processor', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Neural impulse switching core' },
  { id: 'flesh_weave_stabilizer', name: 'Flesh-Weave Stabilizer', category: 'component', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'stabilizer_unit', type: 'item', quantity: 1 }, { itemId: 'veinite', type: 'ingot', quantity: 1 }, { itemId: 'balance_assembly', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Organic-metallic balance damper' },
];

// ─── Armor & Structural Plating (10) ─────────────────────────────────────────
const armorPlatingParts: CraftingRecipe[] = [
  { id: 'skeleton_frame_chassis', name: 'Skeleton Frame Chassis', category: 'component', requiredMachine: 'plasma_welder', ingredients: [{ itemId: 'machine_chassis', type: 'item', quantity: 1 }, { itemId: 'titanium', type: 'ingot', quantity: 2 }, { itemId: 'reinforced_joint', type: 'item', quantity: 2 }], outputQuantity: 1, description: 'Full skeletal armature chassis' },
  { id: 'modular_rail_mount', name: 'Modular Rail Mount', category: 'component', requiredMachine: 'cnc_mill', ingredients: [{ itemId: 'alignment_module', type: 'item', quantity: 1 }, { itemId: 'mounting_bracket', type: 'item', quantity: 2 }, { itemId: 'titanium', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Picatinny-style mounting rail' },
  { id: 'armor_plating_segment', name: 'Armor Plating Segment', category: 'component', requiredMachine: 'plasma_welder', ingredients: [{ itemId: 'structural_panel', type: 'item', quantity: 2 }, { itemId: 'titanium', type: 'ingot', quantity: 2 }], outputQuantity: 1, description: 'Ballistic armor panel segment' },
  { id: 'hexplate_barrier', name: 'Hexplate Barrier', category: 'component', requiredMachine: 'plasma_welder', ingredients: [{ itemId: 'armor_plating_segment', type: 'item', quantity: 2 }, { itemId: 'iridium', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Hexagonal composite impact shield' },
  { id: 'structural_spine', name: 'Structural Spine', category: 'component', requiredMachine: 'plasma_welder', ingredients: [{ itemId: 'structural_matrix', type: 'item', quantity: 1 }, { itemId: 'reinforced_shaft', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Central load-bearing spinal strut' },
  { id: 'kinetic_absorption_plate', name: 'Kinetic Absorption Plate', category: 'component', requiredMachine: 'plasma_welder', ingredients: [{ itemId: 'hexplate_barrier', type: 'item', quantity: 1 }, { itemId: 'dynamic_balancer', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Energy-dampening impact plate' },
  { id: 'composite_frame_core', name: 'Composite Frame Core', category: 'component', requiredMachine: 'plasma_welder', ingredients: [{ itemId: 'heavy_frame', type: 'item', quantity: 1 }, { itemId: 'osmium', type: 'ingot', quantity: 1 }, { itemId: 'reinforced_plate', type: 'item', quantity: 2 }], outputQuantity: 1, description: 'Multi-alloy laminate frame core' },
  { id: 'reinforced_joint_housing', name: 'Reinforced Joint Housing', category: 'component', requiredMachine: 'cnc_mill', ingredients: [{ itemId: 'industrial_joint', type: 'item', quantity: 1 }, { itemId: 'advanced_housing', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Armored articulation housing' },
  { id: 'load_bearing_strut', name: 'Load Bearing Strut', category: 'component', requiredMachine: 'plasma_welder', ingredients: [{ itemId: 'load_bearing_unit', type: 'item', quantity: 1 }, { itemId: 'metal_beam', type: 'item', quantity: 2 }, { itemId: 'tungsten', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'High-capacity structural strut' },
  { id: 'expansion_socket', name: 'Expansion Socket', category: 'component', requiredMachine: 'cnc_mill', ingredients: [{ itemId: 'connector_array', type: 'item', quantity: 1 }, { itemId: 'modular_frame', type: 'item', quantity: 1 }, { itemId: 'silver', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Modular accessory attachment socket' },
];

// ─── Optics & Targeting Systems (10) ─────────────────────────────────────────
const opticsTargetingParts: CraftingRecipe[] = [
  { id: 'smart_optic_lens', name: 'Smart Optic Lens', category: 'electronic', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'energy_focusing_lens', type: 'item', quantity: 1 }, { itemId: 'ruby', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Auto-adjusting smart optical lens' },
  { id: 'neural_hud_link', name: 'Neural HUD Link', category: 'electronic', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'neural_link_socket', type: 'item', quantity: 1 }, { itemId: 'microcontroller', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Direct neural heads-up display link' },
  { id: 'threat_analysis_module', name: 'Threat Analysis Module', category: 'electronic', requiredMachine: 'advanced_fab', ingredients: [{ itemId: 'gpu_core', type: 'item', quantity: 1 }, { itemId: 'signal_amplifier', type: 'item', quantity: 1 }, { itemId: 'gold', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Real-time threat identification unit' },
  { id: 'auto_target_gyro', name: 'Auto-Target Gyro', category: 'electronic', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'compact_gearbox', type: 'item', quantity: 1 }, { itemId: 'motor_controller', type: 'item', quantity: 1 }, { itemId: 'platinum', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Gyroscopic auto-tracking mechanism' },
  { id: 'rangefinding_core', name: 'Rangefinding Core', category: 'electronic', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'sensor_mount', type: 'item', quantity: 1 }, { itemId: 'signal_amplifier', type: 'item', quantity: 1 }, { itemId: 'emerald', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Laser rangefinding computation core' },
  { id: 'motion_tracking_sensor', name: 'Motion Tracking Sensor', category: 'electronic', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'sensor_mount', type: 'item', quantity: 1 }, { itemId: 'microcontroller', type: 'item', quantity: 1 }, { itemId: 'silver', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Predictive motion capture sensor' },
  { id: 'tactical_ai_chip', name: 'Tactical AI Chip', category: 'electronic', requiredMachine: 'advanced_fab', ingredients: [{ itemId: 'processor', type: 'item', quantity: 1 }, { itemId: 'memory_module', type: 'item', quantity: 1 }, { itemId: 'sapphire', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Combat AI decision processor' },
  { id: 'reticle_projector', name: 'Reticle Projector', category: 'electronic', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'led', type: 'item', quantity: 3 }, { itemId: 'smart_optic_lens', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Holographic reticle projection unit' },
  { id: 'heat_signature_scanner', name: 'Heat Signature Scanner', category: 'electronic', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'thermal_plate', type: 'item', quantity: 1 }, { itemId: 'signal_amplifier', type: 'item', quantity: 1 }, { itemId: 'silver', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Infrared thermal imaging array' },
  { id: 'focus_stabilizer', name: 'Focus Stabilizer', category: 'component', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'gravity_stabilizer', type: 'item', quantity: 1 }, { itemId: 'sensor_mount', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Optical tremor compensation system' },
];

// ─── Power Cells & Ammunition Feed (10) ──────────────────────────────────────
const powerAmmoComponents: CraftingRecipe[] = [
  { id: 'energy_cell_cartridge', name: 'Energy Cell Cartridge', category: 'component', requiredMachine: 'cnc_mill', ingredients: [{ itemId: 'energy_channel_core', type: 'item', quantity: 1 }, { itemId: 'compact_housing', type: 'item', quantity: 1 }, { itemId: 'lithium', type: 'ingot', quantity: 2 }], outputQuantity: 1, description: 'High-density rechargeable power cell' },
  { id: 'biofuel_sac', name: 'Biofuel Sac', category: 'component', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'veinite', type: 'ingot', quantity: 1 }, { itemId: 'pressure_core', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Organic biofuel storage bladder' },
  { id: 'plasma_cartridge', name: 'Plasma Cartridge', category: 'component', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'plasma_induction_coil', type: 'item', quantity: 1 }, { itemId: 'compact_housing', type: 'item', quantity: 1 }, { itemId: 'thorium', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Contained plasma bolt capsule' },
  { id: 'coil_battery_pack', name: 'Coil Battery Pack', category: 'component', requiredMachine: 'cnc_mill', ingredients: [{ itemId: 'inductor', type: 'item', quantity: 3 }, { itemId: 'power_transfer_unit', type: 'item', quantity: 1 }, { itemId: 'lithium', type: 'ingot', quantity: 2 }], outputQuantity: 1, description: 'Inductive charge storage pack' },
  { id: 'ammunition_drum_core', name: 'Ammunition Drum Core', category: 'component', requiredMachine: 'cnc_mill', ingredients: [{ itemId: 'rotary_component', type: 'item', quantity: 1 }, { itemId: 'structural_panel', type: 'item', quantity: 1 }, { itemId: 'iron', type: 'ingot', quantity: 3 }], outputQuantity: 1, description: 'Rotary belt-fed drum mechanism' },
  { id: 'injector_feed_system', name: 'Injector Feed System', category: 'component', requiredMachine: 'cnc_mill', ingredients: [{ itemId: 'flow_regulator', type: 'item', quantity: 1 }, { itemId: 'mechanical_joint', type: 'item', quantity: 1 }, { itemId: 'cobalt', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Pressurized chemical injection feed' },
  { id: 'charge_regulator', name: 'Charge Regulator', category: 'electronic', requiredMachine: 'cnc_mill', ingredients: [{ itemId: 'power_regulator', type: 'item', quantity: 1 }, { itemId: 'arc_capacitor', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Charge rate and burst controller' },
  { id: 'power_relay_node', name: 'Power Relay Node', category: 'electronic', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'energy_conduit', type: 'item', quantity: 1 }, { itemId: 'signal_conduit', type: 'item', quantity: 1 }, { itemId: 'gold', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'High-speed power routing node' },
  { id: 'micro_reactor_unit', name: 'Micro Reactor Unit', category: 'component', requiredMachine: 'advanced_fab', ingredients: [{ itemId: 'energy_transfer_core', type: 'item', quantity: 1 }, { itemId: 'thorium', type: 'ingot', quantity: 1 }, { itemId: 'advanced_housing', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Compact fission power source' },
  { id: 'overcharge_reservoir', name: 'Overcharge Reservoir', category: 'component', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'energy_compression', type: 'item', quantity: 1 }, { itemId: 'arc_capacitor', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Surge-power storage reservoir' },
];

// ─── Exotic & Void Artifacts (10) ─────────────────────────────────────────────
const exoticVoidArtifacts: CraftingRecipe[] = [
  { id: 'veinite_resonance_shard', name: 'Veinite Resonance Shard', category: 'component', requiredMachine: 'quantum_lab', ingredients: [{ itemId: 'veinite', type: 'ingot', quantity: 3 }, { itemId: 'veinite_core', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Harmonically attuned veinite crystal' },
  { id: 'blood_crystal_matrix', name: 'Blood Crystal Matrix', category: 'component', requiredMachine: 'quantum_lab', ingredients: [{ itemId: 'veinite', type: 'ingot', quantity: 2 }, { itemId: 'ruby', type: 'ingot', quantity: 1 }, { itemId: 'precision_matrix', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Crystallized veinite lattice structure' },
  { id: 'hollow_core_fragment', name: 'Hollow Core Fragment', category: 'component', requiredMachine: 'quantum_lab', ingredients: [{ itemId: 'void_crystal', type: 'ingot', quantity: 2 }, { itemId: 'void_frame', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Null-space contained hollow core' },
  { id: 'void_infusion_node', name: 'Void Infusion Node', category: 'component', requiredMachine: 'quantum_lab', ingredients: [{ itemId: 'void_crystal', type: 'ingot', quantity: 2 }, { itemId: 'quantum_channel', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Void energy injection point' },
  { id: 'echo_pulse_core', name: 'Echo Pulse Core', category: 'component', requiredMachine: 'quantum_lab', ingredients: [{ itemId: 'void_crystal', type: 'ingot', quantity: 1 }, { itemId: 'pulse_chamber', type: 'item', quantity: 1 }, { itemId: 'phase_alignment_core', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Resonant void-echo amplifier core' },
  { id: 'fracture_catalyst', name: 'Fracture Catalyst', category: 'component', requiredMachine: 'quantum_lab', ingredients: [{ itemId: 'entropy_shard', type: 'ingot', quantity: 1 }, { itemId: 'entropy_assembly', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Entropy-induced material fracture agent' },
  { id: 'obsidian_neural_core', name: 'Obsidian Neural Core', category: 'electronic', requiredMachine: 'quantum_lab', ingredients: [{ itemId: 'dark_matter', type: 'ingot', quantity: 1 }, { itemId: 'synapse_relay_core', type: 'item', quantity: 1 }, { itemId: 'dark_matter_housing', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Dark matter-infused neural logic core' },
  { id: 'warden_imprint_chip', name: 'Warden Imprint Chip', category: 'electronic', requiredMachine: 'quantum_lab', ingredients: [{ itemId: 'tactical_ai_chip', type: 'item', quantity: 1 }, { itemId: 'veinite', type: 'ingot', quantity: 1 }, { itemId: 'temporal_stabilizer', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Ancient warden consciousness imprint' },
  { id: 'parasite_growth_node', name: 'Parasite Growth Node', category: 'component', requiredMachine: 'quantum_lab', ingredients: [{ itemId: 'parasite_host_chamber', type: 'item', quantity: 1 }, { itemId: 'veinite', type: 'ingot', quantity: 2 }, { itemId: 'entropy_assembly', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Self-replicating parasite growth matrix' },
  { id: 'titan_alloy_heart', name: 'Titan Alloy Heart', category: 'component', requiredMachine: 'quantum_lab', ingredients: [{ itemId: 'singularity_chassis', type: 'item', quantity: 1 }, { itemId: 'iridium', type: 'ingot', quantity: 2 }, { itemId: 'veinite', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Indestructible alloy core of titan-class armor' },
];

// ─── Elemental Payload Modules (10) ──────────────────────────────────────────
const elementalPayloadModules: CraftingRecipe[] = [
  { id: 'shockwave_emitter', name: 'Shockwave Emitter', category: 'component', requiredMachine: 'plasma_welder', ingredients: [{ itemId: 'pulse_chamber', type: 'item', quantity: 1 }, { itemId: 'power_transfer_unit', type: 'item', quantity: 1 }, { itemId: 'tungsten', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Concussive pressure-wave emitter' },
  { id: 'incendiary_injector', name: 'Incendiary Injector', category: 'component', requiredMachine: 'cnc_mill', ingredients: [{ itemId: 'injector_feed_system', type: 'item', quantity: 1 }, { itemId: 'gas_regulator_unit', type: 'item', quantity: 1 }, { itemId: 'sulfur', type: 'ingot', quantity: 2 }], outputQuantity: 1, description: 'Ignition-trigger accelerant injector' },
  { id: 'cryo_burst_module', name: 'Cryo Burst Module', category: 'component', requiredMachine: 'cnc_mill', ingredients: [{ itemId: 'cryo_chamber_sleeve', type: 'item', quantity: 1 }, { itemId: 'gas_regulator_unit', type: 'item', quantity: 1 }, { itemId: 'cobalt', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Flash-freeze burst payload' },
  { id: 'corrosion_dispenser', name: 'Corrosion Dispenser', category: 'component', requiredMachine: 'chemical_reactor', ingredients: [{ itemId: 'injector_feed_system', type: 'item', quantity: 1 }, { itemId: 'pressure_core', type: 'item', quantity: 1 }, { itemId: 'sulfur', type: 'ingot', quantity: 2 }], outputQuantity: 1, description: 'Acid mist dispersal module' },
  { id: 'venom_spreader', name: 'Venom Spreader', category: 'component', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'veinite', type: 'ingot', quantity: 1 }, { itemId: 'injector_feed_system', type: 'item', quantity: 1 }, { itemId: 'flow_regulator', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Neurotoxin aerosolization disperser' },
  { id: 'emp_pulse_generator', name: 'EMP Pulse Generator', category: 'electronic', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'arc_capacitor', type: 'item', quantity: 1 }, { itemId: 'ionization_grid', type: 'item', quantity: 1 }, { itemId: 'platinum', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Electromagnetic pulse emitter' },
  { id: 'sonic_disruptor', name: 'Sonic Disruptor', category: 'electronic', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'pulse_chamber', type: 'item', quantity: 1 }, { itemId: 'signal_amplifier', type: 'item', quantity: 2 }, { itemId: 'titanium', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Ultrasonic disruption array' },
  { id: 'flashburn_core', name: 'Flashburn Core', category: 'component', requiredMachine: 'plasma_welder', ingredients: [{ itemId: 'thermal_overdrive_unit', type: 'item', quantity: 1 }, { itemId: 'energy_cell_cartridge', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Instant-ignition thermal core' },
  { id: 'gravity_distorter', name: 'Gravity Distorter', category: 'component', requiredMachine: 'advanced_fab', ingredients: [{ itemId: 'gravity_stabilizer', type: 'item', quantity: 1 }, { itemId: 'quantum_disruptor_node', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Local gravitational field warper' },
  { id: 'adrenal_surge_injector', name: 'Adrenal Surge Injector', category: 'component', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'biofuel_sac', type: 'item', quantity: 1 }, { itemId: 'injector_feed_system', type: 'item', quantity: 1 }, { itemId: 'veinite', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Combat stimulant surge delivery' },
];

// ─── Utility & Maintenance Modules (10) ──────────────────────────────────────
const utilityMaintenanceModules: CraftingRecipe[] = [
  { id: 'cooling_circulation_system', name: 'Cooling Circulation System', category: 'component', requiredMachine: 'cnc_mill', ingredients: [{ itemId: 'cooling_assembly', type: 'item', quantity: 2 }, { itemId: 'flow_regulator', type: 'item', quantity: 1 }, { itemId: 'copper', type: 'ingot', quantity: 2 }], outputQuantity: 1, description: 'Active liquid cooling loop' },
  { id: 'pressure_regulator_valve', name: 'Pressure Regulator Valve', category: 'component', requiredMachine: 'cnc_mill', ingredients: [{ itemId: 'pressure_seal', type: 'item', quantity: 2 }, { itemId: 'flow_regulator', type: 'item', quantity: 1 }, { itemId: 'titanium', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Precision pressure metering valve' },
  { id: 'self_repair_nanite_hub', name: 'Self-Repair Nanite Hub', category: 'electronic', requiredMachine: 'advanced_fab', ingredients: [{ itemId: 'micro_reactor_unit', type: 'item', quantity: 1 }, { itemId: 'nano_frame', type: 'item', quantity: 1 }, { itemId: 'microcontroller', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Autonomous nanite repair distribution hub' },
  { id: 'diagnostic_interface_port', name: 'Diagnostic Interface Port', category: 'electronic', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'data_interface_base', type: 'item', quantity: 1 }, { itemId: 'signal_conduit', type: 'item', quantity: 1 }, { itemId: 'gold', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Full-system diagnostic uplink port' },
  { id: 'manual_override_lever', name: 'Manual Override Lever', category: 'component', requiredMachine: 'cnc_mill', ingredients: [{ itemId: 'mechanical_joint', type: 'item', quantity: 1 }, { itemId: 'metal_rod', type: 'item', quantity: 1 }, { itemId: 'iron', type: 'ingot', quantity: 2 }], outputQuantity: 1, description: 'Fail-safe manual actuator lever' },
  { id: 'safety_lock_matrix', name: 'Safety Lock Matrix', category: 'electronic', requiredMachine: 'cnc_mill', ingredients: [{ itemId: 'logic_controller', type: 'item', quantity: 1 }, { itemId: 'signal_conduit', type: 'item', quantity: 1 }, { itemId: 'silver', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Software-enforced safety interlock' },
  { id: 'signal_booster', name: 'Signal Booster', category: 'electronic', requiredMachine: 'centrifuge', ingredients: [{ itemId: 'signal_amplifier', type: 'item', quantity: 2 }, { itemId: 'hyper_conductor', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Long-range signal amplification array' },
  { id: 'data_logging_core', name: 'Data Logging Core', category: 'electronic', requiredMachine: 'cnc_mill', ingredients: [{ itemId: 'memory_module', type: 'item', quantity: 1 }, { itemId: 'logic_controller', type: 'item', quantity: 1 }, { itemId: 'gold', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'High-speed sensor data recorder' },
  { id: 'calibration_dial_unit', name: 'Calibration Dial Unit', category: 'component', requiredMachine: 'cnc_mill', ingredients: [{ itemId: 'precision_gear', type: 'item', quantity: 2 }, { itemId: 'alignment_module', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Micro-precision calibration wheel' },
  { id: 'emergency_purge_valve', name: 'Emergency Purge Valve', category: 'component', requiredMachine: 'cnc_mill', ingredients: [{ itemId: 'pressure_seal', type: 'item', quantity: 3 }, { itemId: 'mechanical_joint', type: 'item', quantity: 1 }, { itemId: 'titanium', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Rapid-release emergency vent valve' },
];

// ─── Corruption & Mutation Components (10) ───────────────────────────────────
const corruptionMutationComponents: CraftingRecipe[] = [
  { id: 'veinite_overload_core', name: 'Veinite Overload Core', category: 'component', requiredMachine: 'quantum_lab', ingredients: [{ itemId: 'veinite_resonance_shard', type: 'item', quantity: 1 }, { itemId: 'overcharge_reservoir', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Overclock-mode veinite power core' },
  { id: 'flesh_fusion_engine', name: 'Flesh Fusion Engine', category: 'component', requiredMachine: 'quantum_lab', ingredients: [{ itemId: 'veinite_core', type: 'item', quantity: 1 }, { itemId: 'muscle_strand_bundles', type: 'item', quantity: 1 }, { itemId: 'bone_lattice_frame', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Organic-mechanical fusion power core' },
  { id: 'neural_corruptor_spike', name: 'Neural Corruptor Spike', category: 'electronic', requiredMachine: 'quantum_lab', ingredients: [{ itemId: 'obsidian_neural_core', type: 'item', quantity: 1 }, { itemId: 'entropy_assembly', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Entropy-laced neural corruption probe' },
  { id: 'blood_reactor_chamber', name: 'Blood Reactor Chamber', category: 'component', requiredMachine: 'quantum_lab', ingredients: [{ itemId: 'blood_crystal_matrix', type: 'item', quantity: 1 }, { itemId: 'micro_reactor_unit', type: 'item', quantity: 1 }, { itemId: 'veinite', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Crystallized blood-energy fission chamber' },
  { id: 'hive_link_transmitter', name: 'Hive Link Transmitter', category: 'electronic', requiredMachine: 'quantum_lab', ingredients: [{ itemId: 'synapse_relay_core', type: 'item', quantity: 1 }, { itemId: 'signal_booster', type: 'item', quantity: 1 }, { itemId: 'veinite', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Collective hive-mind broadcast transmitter' },
  { id: 'mutation_catalyst_core', name: 'Mutation Catalyst Core', category: 'component', requiredMachine: 'quantum_lab', ingredients: [{ itemId: 'fracture_catalyst', type: 'item', quantity: 1 }, { itemId: 'parasite_growth_node', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Rapid genetic mutation trigger' },
  { id: 'biohazard_containment_shell', name: 'Biohazard Containment Shell', category: 'component', requiredMachine: 'plasma_welder', ingredients: [{ itemId: 'bio_reactive_shell', type: 'item', quantity: 1 }, { itemId: 'hexplate_barrier', type: 'item', quantity: 1 }, { itemId: 'iridium', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Airtight biohazard isolation shell' },
  { id: 'parasite_override_module', name: 'Parasite Override Module', category: 'electronic', requiredMachine: 'quantum_lab', ingredients: [{ itemId: 'parasite_host_chamber', type: 'item', quantity: 1 }, { itemId: 'warden_imprint_chip', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Symbiote behavioral override implant' },
  { id: 'reality_tear_shard', name: 'Reality Tear Shard', category: 'component', requiredMachine: 'quantum_lab', ingredients: [{ itemId: 'singularity_seed', type: 'item', quantity: 1 }, { itemId: 'fracture_catalyst', type: 'item', quantity: 1 }, { itemId: 'void_infusion_node', type: 'item', quantity: 1 }], outputQuantity: 1, description: 'Spacetime fracture crystallized fragment' },
  { id: 'black_vein_conduit', name: 'Black Vein Conduit', category: 'component', requiredMachine: 'quantum_lab', ingredients: [{ itemId: 'void_infusion_node', type: 'item', quantity: 1 }, { itemId: 'flesh_fusion_engine', type: 'item', quantity: 1 }, { itemId: 'dark_matter', type: 'ingot', quantity: 1 }], outputQuantity: 1, description: 'Dark-matter threaded organic conduit' },
];
...
export const CRAFTING_RECIPES: CraftingRecipe[] = [
  ...
  ...machines,
  ...ballisticComponents,
  ...energyWeaponComponents,
  ...bioOrganicParts,
  ...armorPlatingParts,
  ...opticsTargetingParts,
  ...powerAmmoComponents,
  ...exoticVoidArtifacts,
  ...elementalPayloadModules,
  ...utilityMaintenanceModules,
  ...corruptionMutationComponents,
];
